...
function PermisosList() {
    ...
    const endPoint = "https://sena-project.onrender.com/api/v1/data/permisos";
    ...
    return (
        <>
            <div style={{ height: 400, width: '42%', marginTop: '-200px' }}>
                <Grid
                    container
                    direction="row"
            ...
            <div>
                ...
                >
                    <Box sx={style}
                        ...
                        autoComplete="off"
                    >
                        <h1 style={{ textAlign: 'center' }}>Crea un nuevo Permiso</h1>
